...
\begin{tabular}{ll}
(1) & a. \quad \mention{Mom's here.}   (grammatical) \\
 & b. \quad (?) \mention{Teacher's here.}   (acceptable in school-role contexts; otherwise marginal; see Section~\ref{sec:objections}) \\
 & c. \quad (*) \mention{Neighbour's here.}   (ungrammatical in ordinary conversation) \\
\end{tabular}
...
\begin{tabular}{ll}
(2) & a. \quad Common noun: \mention{My mom called.} \\
 & b. \quad Strong proper name: \mention{Mom called.} \\
\end{tabular}
...
\begin{tabular}{ll}
(3) & a. \quad Fully licensed: \mention{Mom}, \mention{Dad}, \mention{Grandma}, \mention{Grandpa} \\
 & b. \quad (?) Marginal: \mention{Auntie}, \mention{Uncle} \\
 & c. \quad (*) Unlicensed: \mention{Brother}, \mention{Sister}, \mention{Aunt}, \mention{Cousin}, \mention{Nephew} \\
\end{tabular}
...
\begin{tabular}{ll}
(4) & a. \quad Stage 1 (Source construction): relational NP headed by a common noun with genitive determinative: \mention{my mom} \\
 & b. \quad Stage 2 (Bridging context): vocative function (determinerless by default): \mention{Mom}, can you\ldots? (For \mention{Auntie} and \mention{Uncle}, the title+name construction provides an alternative bridge: \mention{Auntie Sarah} $\rightarrow$ bare \mention{Auntie}.) \\
 & c. \quad Stage 3 (Target construction): bare NP in argument position, domain-restricted (felicitous only within the family): Tell \mention{Mom} I'm late; \mention{Mom} called. \\
\end{tabular}
...
Two patterns emerge from the per-term data (Figure~\ref{fig:gradient}). First, parent terms aren't merely more frequent overall -- they are \emph{disproportionately concentrated in vocative function}. Parent terms show 16--43\% vocative use, while extended kin terms show only 4--7\%. This is precisely the asymmetry the mechanism predicts: the naming taboo pushes parent terms into the vocative \enquote{bridging context} far more often than it affects terms for aunts, uncles, or cousins.
