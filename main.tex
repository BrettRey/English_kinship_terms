...
\subsection{Syntactic resolution: The Romance test case}

French offers the precise syntactic test that Chinese lacks. Its determiner system is stricter than English's: bare singulars are categorically ungrammatical (\ungram{\mention{Table est là}} is impossible). Yet the naming taboo operates similarly: children address parents as \mention{Maman} and \mention{Papa}.

The prediction holds. Despite the general prohibition, kinship terms used as names appear bare:
\ea
    \ea[]{{\mention{Maman a dit non.}} \hfill (grammatical proper-name usage)}
    \ex[*]{{\mention{Mère a dit non.}} \hfill (ungrammatical common noun)}
    \ex[]{{\mention{Ma mère a dit non.}} \hfill (grammatical relational usage)}
    \z
\z

The mechanism accounts for this exception. The taboo forces \mention{Maman} into the vocative/name slot; frequency entrenches it as a proper name; the proper-name status licenses the bare syntax that is otherwise strictly banned.
