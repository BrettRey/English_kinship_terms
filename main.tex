...
\subsection{The Romance test case}

French offers a precise testing ground. Its determiner system is stricter than English's: bare singulars are categorically ungrammatical in argument position (\ungram{\mention{Table est là}} is impossible; \mention{La table est là} is required). Yet the naming taboo operates similarly: children address parents as \mention{Maman} and \mention{Papa}, not by first name.

The prediction holds. Despite the general prohibition on bare singulars, kinship terms used as names appear bare:
\ea
...
The mechanism accounts for this exception. The taboo forces \mention{Maman} into the vocative/name slot; frequency entrenches it as a proper name; the proper-name status licenses the bare syntax that is otherwise strictly banned. This contrast provides stronger evidence than languages without obligatory determiners, confirming that the taboo overrides the general syntactic constraint.
