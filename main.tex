...
\bottomrule
\end{tabular}
\caption{Kinship term frequencies in CHILDES English-NA (per million words).\protect\footnotemark}\label{tab:childes}
\end{table}
\footnotetext{\mention{Auntie} occurs in CHILDES English-NA too rarely for reliable estimates; the \mention{Auntie}/\mention{Aunt} minimal pair is argued on morphosyntactic rather than corpus grounds (\S\ref{sec:syntax}).}
