...
This mechanism predicts a sharp divergence between parent terms and extended kin. Corpus data confirm this prediction (Section~\ref{sec:frequency}): parent terms show 16--43\% vocative use in CHILDES, compared to only 4--7\% for extended kin terms.
