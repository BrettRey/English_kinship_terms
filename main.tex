...
\ea\label{ex:baresingular}
    ...
    \ex[*]{{\mention{Neighbor's here.}} \hfill (unavailable on intended definite, individuated reading)}
    \z
\z
...
The analytical apparatus comes from \emph{The Cambridge Grammar of the English Language} \citep[hereafter \emph{CGEL}]{Huddleston2002}, which maintains strict category--function distinctions that earlier treatments conflate.
