...
\ea\label{ex:split}
    \ea Semantically as a proper name, syntactically as a bare proper noun: \mention{Mom called.}
...
This isn't polysemy in the usual sense. It's positional: the same lexical item acquires different syntactic privileges depending on whether it's functioning semantically as a proper name or as a descriptive common noun. The grammaticalization story explains \emph{why} kinship terms developed this split: the taboo forces them into proper-name function so frequently that they've acquired the syntactic distributional properties of proper nouns.
