...
This hierarchy tracks address frequency. It's not an arbitrary list; it's a prediction of the mechanism. Terms pushed into name position by high-frequency address should acquire proper-name syntax; terms with lower address frequency shouldn't. As Section~\ref{sec:frequency} demonstrates, corpus data confirm this prediction.
