...
The present paper restricts itself to English, where both the sociolinguistic and syntactic facts are well documented. The cross-linguistic predictions are offered as consequences of the mechanism, not as confirmed findings. Several limitations warrant acknowledgment: the frequency estimates, while plausible, await validation against child-directed speech corpora such as CHILDES; the diachronic trajectory of bare kin-term stabilization remains unexamined; and variation across class, region, ethnicity, and family structure deserves fuller treatment. These are directions for future work, not objections to the core mechanism.
