...
The existence of a dedicated vocative determiner refines the prediction. In English, vocative position is bare, so vocative use and proper-name-like syntax converge in a single morphological form. In Malagasy, they diverge: vocative position takes \mention{ry}, while argument position takes either \mention{ny} (common noun) or \mention{i}/\mention{ra} (proper noun).

The question, then, is not whether teknonyms appear bare (Malagasy doesn't license bareness in the relevant way), but which determiner they select in argument position. If the naming taboo produces proper-name grammaticalization, teknonyms should take the proper-noun determiners \mention{i}/\mention{ra} when used as subjects or objects, even while taking \mention{ry} in vocative position. If they take \mention{ny}, the taboo hasn't produced the syntactic shift the mechanism predicts.

This two-stage pattern~-- \mention{ry} in vocative, \mention{i}/\mention{ra} in argument~-- would provide strong cross-linguistic support. Detailed syntactic work on Zafimaniry teknonyms remains to be done.
