...
\item[\mention{Mother} and \mention{Father}] More formal and lower-frequency; attested as bare singulars but register-sensitive (diary style, conservative familylects, religious contexts).
\item[\mention{Uncle} and \mention{Auntie}] Marginal: \textsuperscript{?}\mention{Uncle said so} requires supportive context or a family-internal convention.
