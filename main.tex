...
A clarification about what is gradient. \emph{CGEL} treats lexical categories as categorical, and this paper doesn't challenge that: a form is either a proper noun or it isn't. What is gradient is \emph{constructional licensing}~-- which constructions accept a given kinship term as a bare argument, and how readily. The present account treats recategorization as a completed outcome for \mention{Mom} and \mention{Dad}, which have acquired proper-noun status through sustained frequency, but an incomplete process for \mention{Uncle} or \mention{Auntie}, which participate in the proper-name construction with varying acceptability without having recategorized. This departs from strict \emph{CGEL} orthodoxy in treating recategorization as emergent rather than stipulated, consistent with usage-based approaches to category emergence \citep{bybee2010,Traugott2003}.
