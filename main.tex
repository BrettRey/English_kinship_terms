...
Second, \emph{address function}: the prohibition forces kinship terms into the slot normally occupied by proper names. \mention{Mom} and \mention{Dad} become the primary vocative forms~-- the words a child uses to get a parent's attention, to address them directly, to refer to them in third-person conversation with other family members. Crucially, the taboo doesn't merely increase frequency; it \emph{eliminates the competitor}. The first name is not just rare; it's prohibited. This total displacement is what makes the kinship case distinctive.
...
Crucially, however, these taboos often drive \emph{lexical replacement}: words are avoided and die out. The English parent-child taboo drives \emph{frequency}: the kinship term is forced into the vacuous slot, leading not to loss but to grammaticalization.
